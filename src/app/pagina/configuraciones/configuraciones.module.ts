...
import { ConfiguracionesRouteModule } from './configuraciones.routes';
...
@NgModule({
  // declarations: [CriteriosComponent, IndicadoresComponent, SubCriteriosComponent,PeridoLectivoComponent],
  declarations: [CriteriosComponent, ConfiguracionesComponent, PeriodoLectivoComponent, SubCriteriosComponent, IndicadoresComponent],
  // exports:[CriteriosComponent, PeriodoLectivoComponent, SubCriteriosComponent],
  imports: [
    CommonModule,
    LayoutModule,
    SidenavModule,
